<section class="py-12">
    <div class="max-w-6xl mx-auto font-[sans-serif] text-[#333]">
        <div class="text-center max-w-2xl mx-auto">
          <h2 class="sm:text-3xl text-2xl font-extrabold">Habilidades e projetos</h2>
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 mt-16 max-md:max-w-lg mx-auto">
          <div class="text-left border rounded-md p-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-600 w-12 mb-4 inline-block bg-blue-50 p-3 rounded-full" viewBox="0 0 32 32">
            ...
            <p class="text-gray-500 text-sm">Tailor our product to suit your needs.</p>
            <button type="button" class="border px-4 py-2 rounded-md font-bold flex items-center text-sm mt-6 hover:bg-gray-50">
          ...
          <div class="text-left border rounded-md p-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-12 mb-4 inline-block bg-blue-50 p-3 rounded-full" viewBox="0 0 682.667 682.667">
              <defs>
          ...
          <div class="text-left border rounded-md p-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-600 w-12 mb-4 inline-block bg-blue-50 p-3 rounded-full" viewBox="0 0 512.001 512.001">
            ...
            <p class="text-gray-500 text-sm">24/7 customer support for all your inquiries.</p>
            <button type="button" class="border px-4 py-2 rounded-md font-bold flex items-center text-sm mt-6 hover:bg-gray-50">
              Learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" class="rotate-90 ml-1.5"><path fill="#333" d="M12.006 1a1 1 0 0 1 .838.463l7 11a1 1 0 0 1-.985 1.527l-3.364-.48a.434.434 0 0 0-.495.43V20c0 1.645-1.355 3-3 3s-3-1.355-3-3v-6.06a.434.434 0 0 0-.495-.43l-3.364.48a1 1 0 0 1-.985-1.527l7-11a1 1 0 0 1 .85-.463z" data-original="#000000" paint-order="fill markers stroke"></path></svg>
            </button>
          </div>
          <div class="text-left border rounded-md p-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-600 w-12 mb-4 inline-block bg-blue-50 p-3 rounded-full" viewBox="0 0 24 24">
          ...
          <div class="text-left border rounded-md p-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-600 w-12 mb-4 inline-block bg-blue-50 p-3 rounded-full" viewBox="0 0 504.69 504.69">
            ...
            <p class="text-gray-500 text-sm">Expand your reach with our global network.</p>
            <button type="button" class="border px-4 py-2 rounded-md font-bold flex items-center text-sm mt-6 hover:bg-gray-50">
              Learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" class="rotate-90 ml-1.5"><path fill="#333" d="M12.006 1a1 1 0 0 1 .838.463l7 11a1 1 0 0 1-.985 1.527l-3.364-.48a.434.434 0 0 0-.495.43V20c0 1.645-1.355 3-3 3s-3-1.355-3-3v-6.06a.434.434 0 0 0-.495-.43l-3.364.48a1 1 0 0 1-.985-1.527l7-11a1 1 0 0 1 .85-.463z" data-original="#000000" paint-order="fill markers stroke"></path></svg>
            </button>
          </div>
          <div class="text-left border rounded-md p-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-12 mb-4 inline-block bg-blue-50 p-3 rounded-full" viewBox="0 0 682.667 682.667">
              ...
              <g fill="none" class="stroke-blue-600" stroke-miterlimit="10" stroke-width="30" clip-path="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
            ...
            <p class="text-gray-500 text-sm">Seamless communication for your team.</p>
            <button type="button" class="border px-4 py-2 rounded-md font-bold flex items-center text-sm mt-6 hover:bg-gray-50">
              Learn more <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" class="rotate-90 ml-1.5"><path fill="#333" d="M12.006 1a1 1 0 0 1 .838.463l7 11a1 1 0 0 1-.985 1.527l-3.364-.48a.434.434 0 0 0-.495.43V20c0 1.645-1.355 3-3 3s-3-1.355-3-3v-6.06a.434.434 0 0 0-.495-.43l-3.364.48a1 1 0 0 1-.985-1.527l7-11a1 1 0 0 1 .85-.463z" data-original="#000000" paint-order="fill markers stroke"></path></svg>
            </button>
          </div>
