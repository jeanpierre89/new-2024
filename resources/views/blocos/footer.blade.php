    ...
    <div class="my-6">
        <div class="max-w-6xl mx-auto bg-[#2e0249] rounded-lg">
            <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
                <div>
                    <h1 class="text-4xl font-extrabold text-white">Entre em contato</h1>
                    <p class="text-sm text-gray-400 mt-3">Vamos juntos evoluir ideias, expandir seu negocio e melhorar sua visibilidade </p>
                    <ul class="mt-12 space-y-8">
                        <li class="flex items-center">
                            ...
                            <a href="javascript:void(0)" class="text-white text-sm ml-3">
                                <strong>jeanpierre.03@gmail.com</strong>
                            </a>
                        </li>
                        <li class="flex items-center">
                ...
                <div class="bg-gray-200 p-6 rounded-lg">
                    <p class="text-sm font-semibold text-[#333]">Meu interesse é...</p>
                    <div class="space-y-4 max-lg:mt-4">
                        <button type="button" class="px-4 py-2 rounded-md bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">Desenvolvimento Web</button>
                        ...
                        <button type="button" class="px-4 py-2 rounded-md bg-transparent text-gray-400 text-sm tracking-wider font-medium outline-none border-2 border-gray-300">Consultoria</button>
                    </div>
    ...
    <footer class="bg-gradient-to-l md:bg-gradient-to-r from-purple-500 to-blue-600 py-6    ">
        <div class="max-w-6xl mx-auto w-full  p-4  lg:py-8 bg-gradient-to-l md:bg-gradient-to-r from-purple-500 to-blue-600 py-12">
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
              <span class="text-sm text-gray-900 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Flowbite™</a>. All Rights Reserved.
              </span>
