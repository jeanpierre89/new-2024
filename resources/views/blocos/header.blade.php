    ...
    <div class='flex flex-wrap items-center justify-between gap-4 px-10 py-4 bg-white min-h-[70px]'>
        ...
        <div id="collapseMenu"
            ...
            <ul
                ...
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                    <a href='{{ route('abaut-me') }}' class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>
                       Abaut
                    </a>
                </li>
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                    <a href='javascript:void(0)' class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>
                        projects
                    </a>
                </li>
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                    <a href='{{ route('blog') }}' class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>
                        Blog
                    </a>
                </li>
                {{-- <li class='max-lg:border-b max-lg:py-3 px-3'>
