@include('blocos.head')
@include('blocos.header')
@include('layout.vitrine')
    ...
    <main class="mt-10">
        ...
        <div class="mb-4 md:mb-0 w-full mx-auto relative">
            <div class="px-4 lg:px-0">
                ...
                <h4 class="py-2 text-green-700 inline-flex items-center justify-center mb-2">Autor:<span> jean
                        pierre</span></h4>
        ...
        <div class="flex flex-col lg:flex-row lg:space-x-12">
            ...
            <div class="px-4 lg:px-0 mt-12 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4">
                <p class="pb-6">Advantage old had otherwise sincerity dependent additions. It in adapted natural
                    ...
                    advantages
                    resolution son indulgence. Part sure on no long life am at ever. In songs above he as drawn to. Gay
                    was
...
@include('blocos.footer')
@include('blocos.scripts')
